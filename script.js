...
BTN.addEventListener('click', () => {
  ...
  // Hide cake button and show present box
...
// Present box toggle logic
const presentBox = document.querySelector('.present-box');
const presentBoxClosed = document.querySelector('.present-box__closed');

presentBoxClosed.addEventListener('click', () => {
  presentBox.classList.toggle('open');
});

// Initially hide present box
